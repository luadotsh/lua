...
* @see app/Http/Controllers/Setting/DomainController.php:26
...
* @see app/Http/Controllers/Setting/DomainController.php:36
* @route '/settings/domains'
*/
...
* @see app/Http/Controllers/Setting/DomainController.php:55
...
* @see app/Http/Controllers/Setting/DomainController.php:68
* @route '/settings/domains/{id}'
*/
...
* @see app/Http/Controllers/Setting/DomainController.php:81
