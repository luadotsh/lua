...
* @see app/Http/Controllers/Setting/DomainController.php:27
...
* @see app/Http/Controllers/Setting/DomainController.php:37
* @route '/settings/domains'
*/
...
* @see app/Http/Controllers/Setting/DomainController.php:69
* @route '/settings/domains/{id}'
*/
...
* @see app/Http/Controllers/Setting/DomainController.php:82
