...
* @see app/Http/Controllers/Setting/DomainController.php:22
...
* @see app/Http/Controllers/Setting/DomainController.php:32
* @route '/settings/domains'
*/
...
* @see app/Http/Controllers/Setting/DomainController.php:52
...
* @see app/Http/Controllers/Setting/DomainController.php:65
* @route '/settings/domains/{id}'
*/
...
* @see app/Http/Controllers/Setting/DomainController.php:78
...
const domains = {
    ...
    validateDns: Object.assign(validateDns, validateDns),
}
