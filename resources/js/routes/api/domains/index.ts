...
* @see app/Http/Controllers/Api/DomainController.php:23
...
* @see app/Http/Controllers/Api/DomainController.php:37
* @route '/api/domains'
*/
...
* @see app/Http/Controllers/Api/DomainController.php:44
* @route '/api/domains'
*/
...
* @see app/Http/Controllers/Api/DomainController.php:56
...
* @see app/Http/Controllers/Api/DomainController.php:68
* @route '/api/domains/{id}'
*/
