...
<template>
    <div class="grid min-h-svh lg:grid-cols-2">
        ...
        <div class="relative hidden overflow-hidden lg:block">
            <div
                class="absolute inset-0 bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-950"
            />
            <div
                class="relative flex h-full flex-col items-center justify-center px-12 text-center xl:px-16"
            >
                <img
                    src="/images/lua/full-white.svg"
                    alt="Lua"
                    class="mb-8 h-16 opacity-90"
                />
                <h2 class="text-2xl font-bold text-white">
                    Short links, deep analytics
                </h2>
                <p class="mt-3 max-w-sm text-sm leading-relaxed text-zinc-400">
                    Track every click, understand your audience, and grow your
                    reach with Lua's powerful link platform.
                </p>
            </div>
        </div>
    </div>
