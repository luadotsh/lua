...
* @see app/Http/Controllers/LinkController.php:30
* @route '/links/{id?}'
*/
...
* @see app/Http/Controllers/LinkController.php:70
* @route '/links/{id}'
*/
...
* @see app/Http/Controllers/LinkController.php:85
* @route '/links/{id}'
*/
...
const LinkController = { index, store, update, destroy }
