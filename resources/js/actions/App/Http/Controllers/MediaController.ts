...
* @see app/Http/Controllers/MediaController.php:46
...
* @see app/Http/Controllers/MediaController.php:28
* @route '/medias/sort'
*/
...
const MediaController = { download, store, sort, thumbnail, destroy }
