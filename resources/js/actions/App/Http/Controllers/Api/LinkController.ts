...
* @see app/Http/Controllers/Api/LinkController.php:20
* @route '/api/links'
*/
...
* @see app/Http/Controllers/Api/LinkController.php:30
* @route '/api/links/{id}'
*/
...
* @see app/Http/Controllers/Api/LinkController.php:40
* @route '/api/links'
*/
...
* @see app/Http/Controllers/Api/LinkController.php:52
* @route '/api/links/{id}'
*/
...
* @see app/Http/Controllers/Api/LinkController.php:64
* @route '/api/links/{id}'
*/
