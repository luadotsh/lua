...
* @see app/Http/Controllers/Setting/AccountController.php:20
...
* @see app/Http/Controllers/Setting/AccountController.php:31
* @route '/settings/account'
*/
...
* @see app/Http/Controllers/Setting/AccountController.php:41
