...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs" full-width>
        ...
        >
            <div
                class="flex items-center gap-2 border-b border-border bg-card px-4 py-3"
            >
                <img
            ...
            <template v-else-if="overview">
                ...
                <div
                    class="grid gap-px border-b border-border bg-border lg:grid-cols-3"
                >
                    <BreakdownCard
                        title="Sources"
