...
defineProps<{
    tools: Array<{ slug: string; name: string; description: string; url: string }>;
    ...
    <SiteLayout>
        <section class="px-6 py-16 sm:px-10 sm:py-24">
            ...
            <div class="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    <h2 class="text-xl font-semibold tracking-tight">{{ tool.name }}</h2>
                    <p class="mt-3 mb-6 text-sm leading-relaxed text-muted-foreground">
                        {{ tool.description }}
                    </p>
