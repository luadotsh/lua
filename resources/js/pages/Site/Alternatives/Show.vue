    ...
    <SiteLayout>
        <article class="mx-auto max-w-4xl px-6 py-16 sm:px-10 sm:py-24">
            ...
            <header class="mt-8">
                ...
                <h1
                    class="mt-1 font-display text-4xl font-semibold tracking-tight text-balance sm:text-5xl"
                >
                    {{ alternative.name }}
                </h1>
                    ...
                    <table class="w-full min-w-[36rem] text-left text-sm">
                        ...
                        <tbody>
                            ...
                            >
                                <th
                                    scope="row"
                                    class="px-4 py-3 font-normal text-muted-foreground"
                                >
                                    {{ row.feature }}
                                </th>
